...
summary(m1.DOC.T0.gam)
anova.gam(m1.DOC.T0.gam)
gam.check(m1.DOC.T0.gam, rep=1000)
draw(m1.DOC.T0.gam)
concrvity(m1.DOC.T0.gam)
par(mfrow = c(2, 2))
plot(m1.DOC.T0.gam, all.terms = TRUE, page=1)
...
anova.gam(m1.DOC.T4.gam)
gam.check(m1.DOC.T4.gam, rep=1000)
draw(m1.DOC.T4.gam)
concrvity(m1.DOC.T4.gam)
par(mfrow = c(2, 2))
plot(m1.DOC.T4.gam, all.terms = TRUE, page=1)
...
DOC.alltimes<-plot_grid(
  DOC.T1.mod.plot+ theme(legend.position = "none")+ ggtitle("Day-10"),
  DOC.T2.mod.plot+ theme(legend.position = "none")+ ggtitle("Day-31"),
  DOC.T3.mod.plot+ theme(legend.position = "none")+ ggtitle("Day-59"),
  DOC.T4.mod.plot+ theme(legend.position = "none")+ ggtitle("Day-89"), extract.legend,
  rel_widths = c(8,8,8,8,3), ncol=5)
ggsave("figures/DOC.alltimes.mod.pdf", height=4, width=12)

DOC.mod.diffs<-plot_grid(
  DOC.diff.T1+ theme(legend.position = "none")+ ggtitle("DOC - Time-1"),
  DOC.diff.T2+ theme(legend.position = "none")+ ggtitle("Time-2"),
  DOC.diff.T3+ theme(legend.position = "none")+ ggtitle("Time-3"),
  DOC.diff.T4+ theme(legend.position = "none")+ ggtitle("Time-4"),
...
anova.gam(m1.TN.T1.gam)
gam.check(m1.TN.T1.gam, rep=1000)
draw(m1.TN.T1.gam)
concrvity(m1.TN.T1.gam)
par(mfrow = c(2, 2))
plot(m1.TN.T1.gam, all.terms = TRUE, page=1)
...
anova.gam(m1.TN.T2.gam)
gam.check(m1.TN.T2.gam, rep=1000)
draw(m1.TN.T2.gam)
concrvity(m1.TN.T2.gam)
par(mfrow = c(2, 2))
plot(m1.TN.T2.gam, all.terms = TRUE, page=1)
...
# Near treatment effect p=0.083, higher TN in unburned
...
TN.mod.alltimes<-plot_grid(
  TN.T0.mod.plot+ theme(legend.position = "none")+ ggtitle("Time-0"),
  TN.T1.mod.plot+ theme(legend.position = "none")+ ggtitle("Time-1"),
  TN.T2.mod.plot+ theme(legend.position = "none")+ ggtitle("Time-2"),
  TN.T3.mod.plot+ theme(legend.position = "none")+ ggtitle("Time-3"),
  TN.T4.mod.plot+ theme(legend.position = "none")+ ggtitle("Time-4"), extract.legend,
  rel_widths = c(8,8,8,8,8,3), ncol=6)
ggsave("figures/TN.mods.plots.pdf", height=5, width=14)

TN.mod.diffs<-plot_grid(
  TN.diff.T0+ theme(legend.position = "none")+ ggtitle("TN - Time-0"),
  TN.diff.T1+ theme(legend.position = "none")+ ggtitle("Time-1"),
  TN.diff.T2+ theme(legend.position = "none")+ ggtitle("Time-2"),
  TN.diff.T3+ theme(legend.position = "none")+ ggtitle("Time-3"),
  TN.diff.T4+ theme(legend.position = "none")+ ggtitle("Time-4"),
  rel_widths = c(8,8,8,8,8,3), ncol=6)
...
Isotopes and C:N for plankton and starting materials
```{r isotopes d15N}
...
CvN.mod2.T1<-lm(Total.N..ug~Total.C..ug, data=topes.trt[(topes.trt$Time.point=="T1"),])
...
CvN.mod2.T2<-lm(Total.N..ug~Total.C..ug, data=topes.trt[(topes.trt$Time.point=="T2"),])
...
###########  
# model for smoothing
m1c.T1.sage<- gam(percent.sage ~ Treatment +
            s(plant.mass..g, by=Treatment), 
            subset = Time.point=="T1", data=topes.trt, method="REML", family="gaussian")
...
###########  
# model for smoothing
m1c.T2.sage<- gam(percent.sage ~ Treatment +
            s(plant.mass..g, by=Treatment), 
            subset = Time.point=="T2", data=topes.trt, method="REML", family="gaussian")
...
###########  
# model for smoothing
m1c.T1.d15N<- gam(d15N ~ Treatment +
            s(plant.mass..g, by=Treatment), 
            subset = Time.point=="T1", data=topes.trt, method="REML", family="gaussian")
...
###########  
# model for smoothing
m1c.T2.d15N<- gam(d15N ~ Treatment +
            s(plant.mass..g, by=Treatment), 
            subset = Time.point=="T2", data=topes.trt, method="REML", family="gaussian")
...
########## %P 
plant.P<-lm(P~treatment +type + plant, data=plant.nut)
...
########## %K
plant.K<-lm(K~treatment +type + plant, data=plant.nut)
...
########## %S
plant.S<-lm(S~treatment +type + plant + treatment:type:plant, data=plant.nut)
anova(plant.S) # type:plant, main effects
...
Make plots and run modesl for CO2
```{r CO2 model plots}
...
par(mfrow = c(1, 2))
plot(m1a.T3.phos, all.terms = TRUE, page=1)
...
CO2.model.plots<-plot_grid(
  CO2.T0.mod.plot+ theme(legend.position= "none") + ggtitle( "T0"),
  CO2.T1.mod.plot+ theme(legend.position= "none") + ggtitle( "T1"),
  CO2.T2.mod.plot+ theme(legend.position= "none") + ggtitle( "T2"),
  CO2.T3.mod.plot+ theme(legend.position= "none") + ggtitle( "T3"),
  extract.legend, 
  rel_widths = c(8,8,8,8,3), ncol=5)
...
CO2.plot.diff<-plot_grid(
  ...
  CO2.diff.T1+ ggtitle("T1"),
  CO2.diff.T2+ ggtitle("T2"),
  CO2.diff.T3+ ggtitle("T3"),
  rel_widths = c(8,8,8,8), ncol=4)
...
summary(m1a.T2.CH4)
anova.gam(m1a.T2.CH4)
gam.check(m1a.T2.CH4, rep=1000)
draw(m1a.T2.CH4)
concrvity(m1a.T2.CH4)
par(mfrow = c(1, 2))
plot(m1a.T2.phos, all.terms = TRUE, page=1)
...
summary(m1a.T3.CH4)
anova.gam(m1a.T3.CH4)
gam.check(m1a.T3.CH4, rep=1000)
draw(m1a.T3.CH4)
concrvity(m1a.T3.CH4)
par(mfrow = c(1, 2))
plot(m1a.T3.phos, all.terms = TRUE, page=1)
...
CH4.plots<-plot_grid(
  CH4.T0.mod.plot+ theme(legend.position= "none") + ggtitle( "T0"),
  CH4.T1.mod.plot+ theme(legend.position= "none") + ggtitle( "T1"),
  CH4.T2.mod.plot+ theme(legend.position= "none") + ggtitle( "T2"),
  CH4.T3.mod.plot+ theme(legend.position= "none") + ggtitle( "T3"), 
  extract.legend, 
  rel_widths = c(8,8,8,8,3), ncol=5)

### model differences
CH4.plot.diff<-plot_grid(
  CH4.diff.T0+ ggtitle("CH4-T0"),
  CH4.diff.T1+ ggtitle("T1"),
  CH4.diff.T2+ ggtitle("T2"),
  CH4.diff.T3+ ggtitle("T3"),
  rel_widths = c(8,8,8,8), ncol=4)

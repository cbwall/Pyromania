...
m1d.T1.CN <- gam(C.N ~ Treatment +
            s(plant.mass..g), 
            subset = Time.point=="T1", data=topes.trt, method="REML", family="gaussian")


AIC(m1a.T1.CN, m1b.T1.CN, m1c.T1.CN, m1d.T1.CN)
...
m1d.T2.CN <- gam(C.N ~ Treatment +
            s(plant.mass..g, by=Treatment), 
            subset = Time.point=="T2", data=topes.trt, method="REML", family="gaussian")

AIC(m1a.T2.CN, m1b.T2.CN, m1c.T2.CN, m1d.T2.CN)
## additive model best fit, but no treatment or type effect
...
AIC(m1a.T1.d15N, m1b.T1.d15N, m1c.T1.d15N, m1d.T1.d15N)
## additive model best fit
...
AIC(m1a.T2.phos,m1b.T2.phos, m1C.T2.phos)
# factor smooth best

...
DOC.df$File1<-substr(DOC.df$File, 10, 24) #give the 10th-24th character of the file name, removing the rest
#alternatively
...
#Combine files from loop to single df
UVBIO.df<-rbind(DOC_NoUV_T0_111721, DOC_UV_T0_111721)
...
# add a time point
# if equals DOC_UV_T0_111721 then, T0, if not then T1
UVBIO.df$Time.point<- as.factor(
  ifelse(UVBIO.df$File=="DOC_UV_T0_111721", "T0",
  ifelse(UVBIO.df$File=="DOC_NoUV_T0_111721", "T0", 
         "T1")))

...
DOC.alltimes<-plot_grid(
  DOC.T1.mod.plot+ theme(legend.position = "none")+ ggtitle("Time-1"),
  DOC.T1.mod.plot+ theme(legend.position = "none")+ ggtitle("Time-2"),
  DOC.T1.mod.plot+ theme(legend.position = "none")+ ggtitle("Time-3"),
  DOC.T1.mod.plot+ theme(legend.position = "none")+ ggtitle("Time-4"), extract.legend,
  rel_widths = c(8,8,8,8,3), ncol=5)
...
CvN.T1.mod.plot<-
  ggplot(data=topes.trt[(topes.trt$Time.point=="T1"),], 
             aes(x=Total.C..ug, y=Total.N..ug, color=Treatment, fill=Treatment)) +
  geom_point(aes(shape=Type))+
...
############# all plankton T1
topes.trt$percent.sage<-100*topes.trt$percent.sage

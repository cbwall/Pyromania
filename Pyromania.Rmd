...
topes.cut<-topes[(topes$Treatment=="burned" | topes$Treatment=="unburned"),]
topes.controls<-topes[!(topes$Treatment=="burned" | topes$Treatment=="unburned"),]


iso.plot<-ggplot(topes.cut, 
...
iso.plot
ggsave("figures/iso.plot.pdf", height=5, width=6)

##########

iso.plot2<-ggplot(data=topes.controls,  aes(x=Type, y=d15N, fill=Type)) +
...
iso.plot2
ggsave("figures/iso.plot_controls.pdf", height=5, width=6)

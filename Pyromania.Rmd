...
iso.mix<-ggplot(topes.trt, aes(x=plant.mass..g, y=percent.sage, color=Treatment)) +
  geom_point() +
  scale_color_manual(values = c("brown1", "mediumseagreen")) + 
  geom_smooth(method=loess, aes(fill=Treatment), alpha=0.1) +
  ylab("% Sage")+
...
mod1 <- gam(percent.sage ~ s(plant.mass..g, k=5, bs="tp") +
            s(plant.mass..g, Treatment, k=5, bs="re"), data=topes.trt, method="REML",
           family="gaussian")
# model with biomass
mod2 <- gam(percent.sage ~ s(plant.mass..g, k=5, bs="tp"), data=topes.trt, method="REML",
          family="gaussian")

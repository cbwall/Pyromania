...
#rearrange
UVBIO.df<- UVBIO.df %>% 
  select(File, Time.point, Treatment, Filter.Trt, UV.Trt, Tank, plant.mass..g, NPOC..mg.L, TN..mg.L) 
...
test_all= cbind(test, test_1)

test_all_2=cbind(test_2, test_3)
...
# Filter it out
Filtered.UV<- complete_test[complete_test$Filter.Trt=="Filtered" & complete_test$UV.Trt=="UV" & complete_test$Time.point=="T2",]
Filtered.NoUV<- complete_test[(complete_test$Filter.Trt=="Filtered" & complete_test$UV.Trt=="NoUV") & complete_test$Time.point=="T2",]
Nofilter.UV<- complete_test[complete_test$Filter.Trt=="Unfiltered" & complete_test$UV.Trt=="UV" & complete_test$Time.point=="T2",]
Nofilter.NoUV<- complete_test[complete_test$Filter.Trt=="Unfiltered" & complete_test$UV.Trt=="NoUV" & complete_test$Time.point=="T2",]


# Make some plots 
Filtered.UV.fig<-ggplot(Filtered.UV, aes(x=plant.mass..g, y=percent.change.NPOC, color=Treatment)) + 
  geom_point() +
  scale_color_manual(values = c("brown1", "mediumseagreen")) + 
  geom_smooth(method=loess, aes(fill=Treatment), alpha=0.1) +
...
Filtered.NoUV.fig<-ggplot(Filtered.NoUV, aes(x=plant.mass..g, y=change.NPOC, color=Treatment)) + 
  geom_point() +
  scale_color_manual(values = c("brown1", "mediumseagreen")) + 
  geom_smooth(method=loess, aes(fill=Treatment), alpha=0.1) +
  coord_cartesian(ylim=c(-5, 40)) +
...
Nofilter.UV.fig<-ggplot(Nofilter.UV, aes(x=plant.mass..g, y=percent.change.NPOC, color=Treatment)) + 
  geom_point() +
  scale_color_manual(values = c("brown1", "mediumseagreen")) + 
  geom_smooth(method=loess, aes(fill=Treatment), alpha=0.1) +
  coord_cartesian(ylim=c(-5, 40)) +
...
Nofilter.NoUV.fig<-ggplot(Nofilter.NoUV, aes(x=plant.mass..g, y=percent.change.NPOC, color=Treatment)) + 
  geom_point() +
  scale_color_manual(values = c("brown1", "mediumseagreen")) + 
  geom_smooth(method=loess, aes(fill=Treatment), alpha=0.1) +
  coord_cartesian(ylim=c(-5, 40)) +
...
# filtered UV plot
Filt.UV.fig<-ggplot(Filt.UV, aes(x=plant.mass..g, y=percent.change.NPOC, color=Treatment)) + 
  geom_point() +
  scale_color_manual(values = c("brown1", "mediumseagreen")) + 
  geom_smooth(method=loess, aes(fill=Treatment), alpha=0.1) +
  coord_cartesian(ylim=c(-5, 40)) +
...
# filtered NoUV plot
F.NoUV.fig<-ggplot(Filt.NoUV, aes(x=plant.mass..g, y=percent.change.NPOC, color=Treatment)) + 
  geom_point() +
  scale_color_manual(values = c("brown1", "mediumseagreen")) + 
  geom_smooth(method=loess, aes(fill=Treatment), alpha=0.1) +
  coord_cartesian(ylim=c(-5, 40)) +
  ggtitle("T1: Filt:NoUV") +
  ylab(expression(paste("%", Delta, " NPOC mg/L"))) +
  xlab("plant material (g)") +
  Fig.formatting

# nofiltered UV plot
NFilt.UV.fig<-ggplot(NFilt.UV, aes(x=plant.mass..g, y=percent.change.NPOC, color=Treatment)) + 
  geom_point() +
  scale_color_manual(values = c("brown1", "mediumseagreen")) + 
  geom_smooth(method=loess, aes(fill=Treatment), alpha=0.1) +
  coord_cartesian(ylim=c(-5, 40)) +
...
NFilt.NoUV.fig<-ggplot(NFilt.NoUV, aes(x=plant.mass..g, y=percent.change.NPOC, color=Treatment)) + 
  geom_point() +
  scale_color_manual(values = c("brown1", "mediumseagreen")) + 
  geom_smooth(method=loess, aes(fill=Treatment), alpha=0.1) +
  coord_cartesian(ylim=c(-5, 40)) +
...
ggsave("figures/UVBio.plots.percent.pdf", height=4, width=11)

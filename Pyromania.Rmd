...
iso.cont.d15N<-cbind(d15N.cont, iso.contr.sd[2])
...
iso.cont.d15N$Type<-factor(iso.cont.d15N$Type, 
...
iso.plot.control<-ggplot(data=iso.cont.d15N,  aes(x=Type, y=d15N, fill=Type)) +
...
iso.plot.control.CN
ggsave("figures/iso.plot_cont.C.N.pdf", encod="MacRoman", height=5, width=6)

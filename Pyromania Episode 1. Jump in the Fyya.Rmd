...
ggsave("figures/NEP.NER.mod.diffs.alt.pdf", height=7, width=12)
...
Test if the C:N was consistent across time, or what factors may influence C:N. This is important to verify assumptions. We are using 15N transer between trophic levels, assuming our measurements of efficiency in nitrogen transfer reflect carbon and energy transfer between trophic levels.
...
CN.all.mod<-lmer(C.N~ Treatment*Type + (1|Time.point), data=topes.trt, na.action=na.exclude) 
print(anova(CN.all.mod, type=3), digits=5)

...
chl.plots
ggsave("figures/review tests/chl.mod.plots.pdf", height=4, width=12)
...
mod.dif.plots<-plot_grid(chl.diff.T0 + ggtitle("Chl-Day-0"), 
                     ...
                     labels=c('A', 'B', 'C', 'D', 'E'), label_size=8)
mod.dif.plots
ggsave("figures/review tests/chl.mod.diff.pdf", height=4, width=10)
...
N.box.test
ggsave("figures/percent.N.box.alt.pdf", encod="MacRoman", height=4, width=4)

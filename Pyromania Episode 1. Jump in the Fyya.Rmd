...
```{r chlorophyll,results='hide', fig.show='hide', message=FALSE, collapse=TRUE}
...
```{r chl plots, results='hide', fig.show='hide', message=FALSE, collapse=TRUE}
...
topes.trt$plant.mass..g.N<- ifelse(topes.trt$Treatment =="burned", topes.trt$plant.mass..g*(1.296545/100), topes.trt$plant.mass..g*(1.177917/100))
...
plant.sum<-aggregate(N~plant+treatment, plant.nut, FUN=mean)
...
```{r GHG excess, fig.cap="**Figure** Greenhouse gas excess for (**A**) carbon dioxide (CO~2~) and (**B**) methane (CH~4~) at the beginning of the study before plant material was added (Day-0) and across three experimental time points.", fig.dim=c(8,6)}

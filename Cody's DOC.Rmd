...
tab_model(m1.DOC.T1.gam, m1.DOC.T2.gam,m1.DOC.T3.gam,m3.DOC.T4.gam, auto.label = T, show.ci= F, show.df = T, CSS= css_theme("cells"), show.stat = TRUE, show.se= T, dv.labels = c( "Day-10", "Day-31", "Day-59", "Day-89"))

...
winner winner
```{r}
m11.gam=gam(DOC..mg.L ~ Treatment*Time.point  + s(plant.mass..g) + s(plant.mass..g, by=oTreatment) + s(plant.mass..g, by=oTime.point, bs="fs"), family= Gamma(link="log"), data=DOC.df2, select= T, method="REML")
summary(m11.gam)

...
m11.gam=gam(DOC..mg.L ~ Treatment  + s(plant.mass..g, Time.point, by=Treatment, bs="fs", k=12), family= Gamma(link="log"), data=DOC.df2, select= T, method="REML")
summary(m11.gam)


AIC(m8.gam, m9.gam, m10.gam, m11.gam)
```
...
#interpret the exponentiated coefficients multiplicatively rather than additively. They give you the multiplier on the expected value when 𝑥 changes by 1.

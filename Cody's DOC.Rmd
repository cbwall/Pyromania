...
plot_grid(
  ggdraw(add_sub(perc.degra.plots, "Fig 2. Three degradation pathways of dissolved organic carbon (DOC) across three time points during a seven \nday incubation period for both treatments. 'Microbe' represents the percent change in DOC due to microbial \ndegradation, 'photo' represents the percent change in DOC due to  photodegradation, and 'total' represents the \npercent change in DOC due to both microbial and photodegradation.", x=0.01, hjust=0)), ncol = 1)

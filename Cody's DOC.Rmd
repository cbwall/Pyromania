...
library(flextable)
DOC.table_T0=as_flextable(DOC.sum_T0)
DOC.table_T0=autofit(DOC.table_T0)
...
save_as_docx(DOC.table_T0, 
  path = "Codys.tables/DOC.table.docx", pr_section = sect_properties )

DOC.table_T1=as_flextable(m1.DOC.T1.gam)
DOC.table_T2=as_flextable(m1.DOC.T2.gam)
DOC.table_T3=as_flextable(m1.DOC.T3.gam)
DOC.table_T4=as_flextable(m1.DOC.T4.gam)


ggsave("Codys.tables/DOC.table.pdf", height=4, width=6)
...
degra.mod.allsums
write.csv(degra.mod.allsums, "Codys.tables/degra.mod.allsums.csv")

#convert dataframe into a table for export
pdf("Codys.tables/degra.mod.allsums.pdf", width = 9, height = 3)       # Export PDF

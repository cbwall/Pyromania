...
```{r}
DOC.T0.box<-ggplot(DOC.df[(DOC.df$Time.point=="T0"),], aes(x=Treatment, y=DOC..mg.L, fill=Treatment)) +
...
DOC.T1.box<-ggplot(DOC.df[(DOC.df$Time.point=="T1"),], aes(x=Treatment, y=DOC..mg.L, fill=Treatment)) +
  geom_boxplot(aes(fill=Treatment))+
  scale_fill_manual(values = c("orange", "purple")) + 
  coord_cartesian(ylim=c(0, 60)) +
  ggtitle("Time-1") +
...
DOC.T2.box<-ggplot(DOC.df[(DOC.df$Time.point=="T2"),], aes(x=Treatment, y=DOC..mg.L, fill=Treatment)) +
  geom_boxplot(aes(fill=Treatment))+
  scale_fill_manual(values = c("orange", "purple")) + 
  coord_cartesian(ylim=c(0, 60)) +
  ggtitle("Time-2") +
...
DOC.T3.box<-ggplot(DOC.df[(DOC.df$Time.point=="T3"),], aes(x=Treatment, y=DOC..mg.L, fill=Treatment)) +
  geom_boxplot(aes(fill=Treatment))+
  scale_fill_manual(values = c("orange", "purple")) + 
  coord_cartesian(ylim=c(0, 60)) +
  ggtitle("Time-3") +
...
DOC.T4.box<-ggplot(DOC.df[(DOC.df$Time.point=="T4"),], aes(x=Treatment, y=DOC..mg.L, fill=Treatment)) +
  geom_boxplot(aes(fill=Treatment))+
  scale_fill_manual(values = c("orange", "purple")) + 
  coord_cartesian(ylim=c(0, 60)) +
  ggtitle("Time-4") +
...
DOC.box.plots<-plot_grid(
  DOC.T0.box+ theme(legend.position = "none"),
  DOC.T1.box+ theme(legend.position = "none"),
  DOC.T2.box+ theme(legend.position = "none"),
  DOC.T3.box+ theme(legend.position = "none"),
  DOC.T4.box+ theme(legend.position = "none"),
  rel_widths = c(50,50,50,50, 50, 20), ncol=6)
DOC.box.plots

#combine all DOC plots
DOC.combo.plots<-plot_grid(
  DOC.plots, DOC.box.plots ,nrow=2)
DOC.combo.plots



library(ggpubr)
ggarrange(DOC.plots, DOC.box.plots, labels = c("a)", "b)"), common.legend = TRUE, legend="right", nrow=2)

ggsave("figures/DOC.combo.plots.pdf", height=8, width=14)
...
TN.T0.box<-ggplot(DOC.df[(DOC.df$Time.point=="T0"),], aes(x=Treatment, y=TN..mg.L, fill=Treatment)) +
  geom_boxplot(aes(fill=Treatment))+
  scale_fill_manual(values = c("orange", "purple")) + 
  coord_cartesian(ylim = c(0,1.5))+
  ggtitle("Time-0") +
...
TN.T1.box<-ggplot(DOC.df[(DOC.df$Time.point=="T1"),], aes(x=Treatment, y=TN..mg.L, fill=Treatment)) +
  geom_boxplot(aes(fill=Treatment))+
  scale_fill_manual(values = c("orange", "purple")) + 
  coord_cartesian(ylim = c(0,1.5))+
  ggtitle("Time-1") +
...
TN.T2.box<-ggplot(DOC.df[(DOC.df$Time.point=="T2"),], aes(x=Treatment, y=TN..mg.L, fill=Treatment)) +
  geom_boxplot(aes(fill=Treatment))+
  scale_fill_manual(values = c("orange", "purple")) + 
  coord_cartesian(ylim = c(0,1.5))+
  ggtitle("Time-2") +
...
TN.T3.box<-ggplot(DOC.df[(DOC.df$Time.point=="T3"),], aes(x=Treatment, y=TN..mg.L, fill=Treatment)) +
  geom_boxplot(aes(fill=Treatment))+
  scale_fill_manual(values = c("orange", "purple")) + 
  coord_cartesian(ylim = c(0,1.5))+
  ggtitle("Time-3") +
...
TN.T4.box<-ggplot(DOC.df[(DOC.df$Time.point=="T4"),], aes(x=Treatment, y=TN..mg.L, fill=Treatment)) +
  geom_boxplot(aes(fill=Treatment))+
  scale_fill_manual(values = c("orange", "purple")) + 
  coord_cartesian(ylim = c(0,1.5))+
  ggtitle("Time-4") +
...
extract.legend <- get_legend(
  # create some space to the left of the legend
  TN.T0.box + theme(legend.box.margin = margin(0, 0, 0, 10)))


TN.box.plots<-plot_grid(
  TN.T0.box+ theme(legend.position = "none"),
  TN.T1.box+ theme(legend.position = "none"),
  TN.T2.box+ theme(legend.position = "none"),
  TN.T3.box+ theme(legend.position = "none"),
  TN.T4.box+ theme(legend.position = "none"),
  rel_widths = c(50,50,50,50, 50, 20), ncol=6)
...
#combine all DOC plots
TN.combo.plots<-plot_grid(
  TN.plots, TN.box.plots ,nrow=2)
TN.combo.plots



library(ggpubr)
ggarrange(TN.plots, TN.box.plots, common.legend = TRUE, legend="right", nrow=2)

ggsave("figures/TN.combo.plots.pdf", height=8, width=14)
...
photo.df=data.frame(UVBIO.df[UVBIO.df$Filt.UV=="Filtered.UV",]$Time.point,
                    ...
                    UVBIO.df[UVBIO.df$Filt.UV=="Filtered.UV",]$DOC..mg.L-UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.DOC,
                    100*(UVBIO.df[UVBIO.df$Filt.UV=="Filtered.UV",]$DOC..mg.L-UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.DOC)/(abs(UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.DOC)), 
                     UVBIO.df[UVBIO.df$Filt.UV=="Filtered.UV",]$TN..mg.L-UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.TN,
                    100*(UVBIO.df[UVBIO.df$Filt.UV=="Filtered.UV",]$TN..mg.L-UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.TN)/(abs(UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.TN)))
...
photo.df$mass.remaining.DOC=100-abs(photo.df[photo.df$type=="photo",]$percent.change.DOC)
photo.df$mass.remaining.TN=100-abs(photo.df[photo.df$type=="photo",]$percent.change.TN)
...
microbe.df=data.frame(UVBIO.df[UVBIO.df$Filt.UV=="Unfiltered.NoUV",]$Time.point,
                    ...
                    UVBIO.df[UVBIO.df$Filt.UV=="Unfiltered.NoUV",]$DOC..mg.L- UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.DOC,
                    100*(UVBIO.df[UVBIO.df$Filt.UV=="Unfiltered.NoUV",]$DOC..mg.L-UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.DOC)/(abs( UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.DOC)),
                     UVBIO.df[UVBIO.df$Filt.UV=="Unfiltered.NoUV",]$TN..mg.L-UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.TN,
                    100*(UVBIO.df[UVBIO.df$Filt.UV=="Unfiltered.NoUV",]$TN..mg.L-UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.TN)/(abs(UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.TN)))
...
total.df=data.frame(UVBIO.df[UVBIO.df$Filt.UV=="Unfiltered.UV",]$Time.point,
                    ...
                    UVBIO.df[UVBIO.df$Filt.UV=="Unfiltered.UV",]$DOC..mg.L-UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.DOC,
                     100*(UVBIO.df[UVBIO.df$Filt.UV=="Unfiltered.UV",]$DOC..mg.L-UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.DOC)/(abs(UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.DOC)),
                      UVBIO.df[UVBIO.df$Filt.UV=="Unfiltered.UV",]$TN..mg.L-UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.TN,
                     100*(UVBIO.df[UVBIO.df$Filt.UV=="Unfiltered.UV",]$TN..mg.L-UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.TN)/(abs(UVBIO.df[UVBIO.df$Filt.UV=="Filtered.NoUV",]$Start.TN)))
...
total.df$mass.remaining.DOC=100-abs(total.df[total.df$type=="total",]$percent.change.DOC)
total.df$mass.remaining.TN=100-abs(total.df[total.df$type=="total",]$percent.change.TN)
...
mass.unburned.degra.plot=ggplot(degra.df[(degra.df$Time.point=="T1"),])+ 
   geom_point(aes(x=plant.mass..g,y=percent.change.DOC,color=effect),alpha=0.5)+
  facet_grid(~Treatment)+
   geom_smooth(aes(x=plant.mass..g, y=percent.change.DOC, color=effect), method="gam", formula= y~s(x))+
...
```{r}
#Unburned treatment decomp
ggplot(degra.df[(degra.df$Time.point=="T1"),])+ 
  geom_boxplot(aes(x=Treatment,y=percent.change.DOC,fill=effect))+
  scale_fill_manual(values = c("green", "yellow", "blue")) + 
  ggtitle("Degradation") +
  ylab(expression(paste("%", Delta, "DOC Change (mg/L)"))) +
  xlab("Treatment")+
  theme_cowplot(12)+
  theme(legend.title=element_blank())
...
mass.box.plots=plot_grid(mass.sage.box.plot + theme(legend.position = "none", 
...
ggarrange(mass.decomp.plots, mass.box.plots, common.legend = T, 
          labels = c("a)", "b)"),
          nrow=2)

mass.combo.plots
ggsave("figures/decomp.combo.plots.pdf", height=6, width=9)


```

UVBIO DOC with just T1
```{r}

UVBIO.T1.DOC<-ggplot(degra.df[(degra.df$Time.point=="T1"),], aes(x=plant.mass..g, y=percent.change.DOC, color=effect))+
  facet_grid(~Treatment)+
  geom_point(alpha=0.5) +
  scale_color_manual(values = c("springgreen1", "gold", "midnightblue")) + 
...
UVBIO.T1.box.DOC<-ggplot(degra.df[(degra.df$Time.point=="T1"),], aes(x=Treatment, y=percent.change.DOC, fill=effect))+
  geom_boxplot(aes(fill=effect))+
  scale_fill_manual(values = c("springgreen1", "gold", "midnightblue")) + 
  ylab(expression(paste("%", Delta, "DOC (mg/L)")))+
  xlab("Treatment")+
  theme_cowplot(12)+
  theme(legend.title=element_blank())
...
ggarrange(UVBIO.T1.DOC, UVBIO.T1.box.DOC, common.legend = T, legend = "right", 
          labels = c("a)", "b)"),
          nrow=2)


ggsave("figures/T1.UVBio.mass.degra_type.plots.pdf", height=5, width=10)
ggsave("figures/T1.degra.combo.plot.pdf", height=6, width=8)
...
UVBIO.T1.TN<-ggplot(degra.df[(degra.df$Time.point=="T1"),], aes(x=plant.mass..g, y=percent.change.TN, color=effect))+
  facet_grid(~Treatment)+
  geom_point(alpha=0.5) +
  scale_color_manual(values = c("springgreen1", "gold", "midnightblue")) + 
  geom_smooth(method=gam, formula= y~s(x), aes(fill=effect), alpha=0.1) +
  ylab(expression(paste("%", Delta, "TDN (mg/L)")))+
  xlab("Plant mass (g)")+
  theme_cowplot(12)+
  theme(legend.title=element_blank())

UVBIO.T1.box.TN<-ggplot(degra.df[(degra.df$Time.point=="T1"),], aes(x=Treatment, y=percent.change.TN, fill=effect))+
  geom_boxplot(aes(fill=effect))+
  scale_fill_manual(values = c("springgreen1", "gold", "midnightblue")) + 
  ylab(expression(paste("%", Delta, "TDN (mg/L)")))+
  xlab("Treatment")+
...
ggarrange(UVBIO.T1.TN, UVBIO.T1.box.TN, common.legend = T, legend = "right", 
          labels = c("a)", "b)"),
          nrow=2)

ggsave("figures/T1.degra.combo.TN.plot.pdf", height=6, width=8)
...
mass.decomp.plots=plot_grid(
  mass.unburned.decomp.plot + theme(legend.position = "none"), 
  mass.burned.decomp.plot + theme(legend.position = "none"),
          extract.legend,
...
suva.combo.plots=ggarrange(suva.plots, suva.box.plots, nrow=2, legend = "right",common.legend = T)
...
index.combo.plots=ggarrange(fresh.combo.plots, fluoro.combo.plots, humic.combo.plots, labels = c("a)", "b)", "c)"),nrow=3, common.legend = T, legend = "right")



ggsave("figures/index.combo.plots.pdf", height=30, width=15)

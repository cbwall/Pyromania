...
#visualize
ggplot(DOC.df, aes(x = hum, y = spec, colour = Treatment)) +
    geom_point() +
...
DOC.T0<-ggplot(DOC.df[(DOC.df$Time.point=="T0"),], aes(x=plant.mass..g, y=DOC..mg.L, color=Treatment, linetype=Treatment)) +

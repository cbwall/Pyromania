...
uv.m2.gam=gam(log(percent.change.DOC+1) ~ Treatment*type*Time.point + s(plant.mass..g, by=oTreatment) + s(plant.mass..g, by=oTime.point) + s(plant.mass..g, by= otype), data=degra.df, method="REML", select= T)
summary(uv.m2.gam)

...
mod.DOC.rep<-rep(c("T0: Treatment with by-factor smooth", 
              "T0: Treatment with global smooth", 
              "T0: global smooth",
              "T1: Treatment with by-factor smooth", 
              "T1: Treatment with global smooth", 
              "T1: global smooth",
              "T2: Treatment with by-factor smooth", 
              "T2: Treatment with global smooth", 
              "T2: global smooth",
              "T3: Treatment with by-factor smooth", 
              "T3: Treatment with global smooth", 
              "T3: global smooth",
              "T4: Treatment with by-factor smooth", 
              "T4: Treatment with global smooth", 
              "T4: global smooth"))
...
rownames(AIC.DOC.mod)<-c(1:15)

write.csv(AIC.DOC.mod, "output/AIC models/AIC.DOC.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/DOC.mod.AIC.pdf", width = 5.5, height = 4.5)       # Export PDF
grid.table(AIC.DOC.mod)
dev.off()
...
DOC.smooth.sums <- DOC.smooth.sums %>%
  # Creating an empty column:
  add_column(Model= c("Day 10 Model: s(plant.mass):burned","Day 10 Model: s(plant.mass):unburned","Day 31 Model: s(plant.mass):burned","Day 31 Model: s(plant.mass):unburned","Day 59 Model: s(plant.mass):burned","Day 59 Model: s(plant.mass):unburned","Day 89 Model: s(plant.mass):burned","Day 89 Model: s(plant.mass):unburned"), .before="df/edf")
...
DOC.mod.allsums <- DOC.mod.allsums %>%
  # Creating an empty column:
  add_column(Identity= c("DOC"), .before="Model")

#convert dataframe into a table for export
pdf("output/Codys.tables/DOC.mod.allsums.pdf", width = 9.5, height = 4)       # Export PDF
grid.table(DOC.mod.allsums)
dev.off()


write.csv(DOC.mod.allsums, "Codys.tables/DOCmod.allsums.csv")
...
# no effect of treatment, smoothing significant across both treatments
# DOC equivalent in  burned and unburned
mod.suva.rep<-rep(c("T0: Treatment with by-factor smooth", 
              "T0: Treatment with global smooth", 
              "T0: global smooth",
              "T1: Treatment with by-factor smooth", 
              "T1: Treatment with global smooth", 
...
rownames(AIC.suva.mod)<-c(1:15)

write.csv(AIC.suva.mod, "output/AIC models/AIC.suva.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/suva.mod.AIC.pdf", width = 5.5, height = 4.5)       # Export PDF
grid.table(AIC.suva.mod)
dev.off()
...
suva.mod.allsums <- suva.mod.allsums %>%
  # Creating an empty column:
  add_column(Identity= c("SUVA"), .before="Model")


write.csv(suva.mod.allsums, "Codys.tables/suva.mod.allsums.csv")
...
mod.sr.rep<-rep(c("T0: Treatment with by-factor smooth", 
              "T0: Treatment with global smooth", 
              "T0: global smooth",
              "T1: Treatment with by-factor smooth", 
              "T1: Treatment with global smooth", 
...
rownames(AIC.sr.mod)<-c(1:15)

write.csv(AIC.sr.mod, "output/AIC models/AIC.sr.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/sr.mod.AIC.pdf", width = 5.5, height = 4.5)       # Export PDF
grid.table(AIC.sr.mod)
dev.off()
```
...
sr.mod.allsums <- sr.mod.allsums %>%
  # Creating an empty column:
  add_column(Identity= c("Sr"), .before="Model")

write.csv(sr.mod.allsums, "Codys.tables/sr.mod.allsums.csv")
...
# no effect of treatment, smoothing significant across both treatments
# DOC equivalent in  burned and unburned
mod.hix.rep<-rep(c("T0: Treatment with by-factor smooth", 
              "T0: Treatment with global smooth", 
              "T0: global smooth",
              "T1: Treatment with by-factor smooth", 
              "T1: Treatment with global smooth", 
...
mod.hix.column<- data.frame(mod.sr.rep)
AIC.hix<-bind_rows(T0.sr.AIC, T1.sr.AIC, T2.sr.AIC, T3.sr.AIC, T4.sr.AIC)

AIC.hix.mod<-as.data.frame(cbind(mod.sr.column, AIC.sr))

names(AIC.hix.mod)[1]="Model"
rownames(AIC.hix.mod)<-c(1:15)

write.csv(AIC.hix.mod, "output/AIC models/AIC.hix.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/hix.mod.AIC.pdf", width = 5.5, height = 4.5)       # Export PDF
grid.table(AIC.hix.mod)
dev.off()
...
rownames(hix.mod.allsums)<-c(1:12)

#create new ID column
hix.mod.allsums <- hix.mod.allsums %>%
  # Creating an empty column:
  add_column(Identity= c("HIX"), .before="Model")

write.csv(hix.mod.allsums, "Codys.tables/hix.mod.allsums.csv")
...
rownames(fr.mod.allsums)<-c(1:12)

#create new ID column
fr.mod.allsums <- fr.mod.allsums %>%
  # Creating an empty column:
  add_column(Identity= c("FR"), .before="Model")

write.csv(fr.mod.allsums, "Codys.tables/fr.mod.allsums.csv")

mod.fr.rep<-rep(c("T0: Treatment with by-factor smooth", 
              "T0: Treatment with global smooth", 
              "T0: global smooth",
              "T1: Treatment with by-factor smooth", 
              "T1: Treatment with global smooth", 
...
rownames(AIC.fr.mod)<-c(1:15)

write.csv(AIC.fr.mod, "output/AIC models/AIC.fr.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/fr.mod.AIC.pdf", width = 5.5, height = 4.5)       # Export PDF
grid.table(AIC.fr.mod)
dev.off()
...
# DOC equivalent in  burned and unburned
##combine AIC
mod.fl.rep<-rep(c("T0: Treatment with by-factor smooth", 
              "T0: Treatment with global smooth", 
              "T0: global smooth",
              "T1: Treatment with by-factor smooth", 
              "T1: Treatment with global smooth", 
...
rownames(AIC.fl.mod)<-c(1:15)

write.csv(AIC.fl.mod, "output/AIC models/AIC.fl.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/fl.mod.AIC.pdf", width = 5.5, height = 4.5)       # Export PDF
grid.table(AIC.fl.mod)
dev.off()
...
fl.mod.allsums <- fl.mod.allsums %>%
  # Creating an empty column:
  add_column(Identity= c("FI"), .before="Model")

write.csv(fl.mod.allsums, "Codys.tables/fl.mod.allsums.csv")
...
Generate dataframe for all index model outputs
```{r}
library(gridExtra)
#merge all the dataframes
index.mod.allsums=rbind(suva.mod.allsums,sr.mod.allsums,hix.mod.allsums,fr.mod.allsums,fl.mod.allsums)

#convert dataframe into a table for export
pdf("Codys.tables/index.mod.allsums.pdf", width = 9.5, height = 17)       # Export PDF
grid.table(index.mod.allsums)
dev.off()
...
rownames(AIC.degra.mod)<-c(1:9)

write.csv(AIC.degra.mod, "output/AIC models/AIC.degra.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/degra.mod.AIC.pdf", width = 6, height = 3)       # Export PDF
grid.table(AIC.degra.mod)
dev.off()
...
rownames(degra.mod.allsums)<-c(1:9)
degra.mod.allsums
write.csv(degra.mod.allsums, "/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/degra.mod.allsums.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/degra.mod.allsums.pdf", width = 9, height = 3)       # Export PDF
grid.table(degra.mod.allsums)
dev.off()
...
rownames(AIC.degra.suva.mod)<-c(1:9)

write.csv(AIC.degra.suva.mod, "output/AIC models/AIC.degra.suva.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/degra.suva.mod.AIC.pdf", width = 6, height = 3)       # Export PDF
grid.table(AIC.degra.suva.mod)
dev.off()
...
rownames(degra.suva.mod.allsums)<-c(1:9)

write.csv(degra.suva.mod.allsums, "/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/degra.suva.mod.allsums.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/degra.suva.mod.allsums.pdf", width = 9, height = 3)       # Export PDF
grid.table(degra.suva.mod.allsums)
dev.off()
...
photo.hix.AIC
photo.hix.anova=anova(m2.hix.photo)
photo.hix.anova
...
rownames(degra.hix.mod.allsums)<-c(1:9)

write.csv(degra.hix.mod.allsums, "/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/degra.hix.mod.allsums.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/degra.hix.mod.allsums.pdf", width = 9, height = 3)       # Export PDF
grid.table(degra.hix.mod.allsums)
dev.off()
...
degra.indices.mod.plot<-plot_grid(
degra.suva.mod.plot+ theme(legend.position = "none"),
degra.hix.mod.plot+ theme(legend.position = "none"),
degra.sr.mod.plot+ theme(legend.position = "none"), nrow=3, rel_widths = c(8,8,8), labels = "AUTO")

degra.indices.mod.plot

ggsave("figures/degra.indices.mod.plot.pdf", height=12, width=12)
...
###Sage
m1.sage.gam=gam(delta.trans ~ treatment +s(plant.specific.mass..g, by= treatment), data=plant.df, method="REML", select= T, subset= plant.type=="sage")

hist(m6.sage.gam$residuals)

m2.sage.gam=gam(delta.trans ~ treatment +s(plant.specific.mass..g), data=plant.df, method="REML", select= T, subset= plant.type=="sage")

m3.sage.gam=gam(delta.trans ~ s(plant.specific.mass..g), data=plant.df, method="REML", select= T, subset= plant.type=="sage")

m4.sage.gam=gam(perc.loss ~ treatment +s(plant.specific.mass..g, by= treatment), data=plant.df, method="REML", select= T, subset= plant.type=="sage")

hist(m3.sage.gam$residuals)

m5.sage.gam=gam(perc.loss ~ treatment +s(plant.specific.mass..g), data=plant.df, method="REML", select= T, subset= plant.type=="sage")

m6.sage.gam=gam(perc.loss ~ s(plant.specific.mass..g), data=plant.df, method="REML", select= T, subset= plant.type=="sage")

sage.AIC=AIC(m1.sage.gam, m2.sage.gam, m3.sage.gam, m4.sage.gam, m5.sage.gam, m6.sage.gam)
sage.AIC

sage.anova=anova(m6.sage.gam)
sage.anova
...
sage.mod.plot<-
  ...
  geom_point(data=plant.df[(plant.df$plant.type=="sage"),], 
             aes(x=plant.specific.mass..g, y=delta.trans, color=treatment)) +
   scale_color_manual(values = c("brown1", "mediumseagreen")) +
  scale_fill_manual(values = c("brown1", "mediumseagreen")) +
  ggtitle("Sage") +
 ylab("Mass Loss (g)") +
...
### Willow
m1.willow.gam=gam(delta.trans ~ treatment +s(plant.specific.mass..g, by= treatment), data=plant.df, method="REML", select= T, subset= plant.type=="willow")


m2.willow.gam=gam(delta.trans ~ treatment +s(plant.specific.mass..g), data=plant.df, method="REML", select= T, subset= plant.type=="willow")

m3.willow.gam=gam(delta.trans ~ s(plant.specific.mass..g), data=plant.df, method="REML", select= T, subset= plant.type=="willow")

m4.willow.gam=gam(perc.loss ~ treatment +s(plant.specific.mass..g, by= treatment), data=plant.df, method="REML", select= T, subset= plant.type=="willow")
...
m6.willow.gam=gam(perc.loss ~ s(plant.specific.mass..g), data=plant.df, method="REML", select= T, subset= plant.type=="willow")

willow.AIC=AIC(m1.willow.gam, m2.willow.gam, m3.willow.gam, m4.willow.gam,m5.willow.gam,m6.willow.gam)
willow.AIC
# treatment with global smooth

summary(m3.willow.gam)
willow.anova=anova(m1.willow.gam)
willow.anova
...
AIC.decomp.mod
rownames(AIC.decomp.mod)<-c(1:6)

write.csv(AIC.decomp.mod, "output/AIC models/AIC.decomp.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/decomp.mod.AIC.pdf", width = 5.5, height = 2)       # Export PDF
grid.table(AIC.decomp.mod)
dev.off()
...
decomp.smooth.sums <- decomp.smooth.sums %>%
  # Creating an empty column:
  add_column(Model= c("Sage Model: s(plant.mass):burned","Sage Model: s(plant.mass):unburned","Willow Model: s(plant.mass):burned","Willow Model: s(plant.mass):unburned"), .before="df/edf")

#merge the dataframes
decomp.mod.allsums=rbind(decomp.para.sums,decomp.smooth.sums)
rownames(decomp.mod.allsums)<-c(1:6)
write.csv(decomp.mod.allsums, "Codys.tables/decomp.mod.allsums.csv")


#convert dataframe into a table for export
pdf("Codys.tables/decomp.mod.allsums.pdf", width = 9, height = 3)       # Export PDF
grid.table(decomp.mod.allsums)
dev.off()
...
willow.mod.plot+ theme(legend.position = "none"),
  rel_widths = c(8,8), ncol=2, labels = "AUTO")
...
m1.compare.burned.gam=gam(perc.loss ~ plant.type + s(plant.specific.mass..g, by=plant.type), data=plant.df, methods= "REML", select= T, subset= treatment == "burned")

m2.compare.burned.gam=gam(perc.loss ~ plant.type + s(plant.specific.mass..g), data=plant.df, methods= "REML", select= T, subset= treatment == "burned")

m3.compare.burned.gam=gam(perc.loss ~ s(plant.specific.mass..g), data=plant.df, methods= "REML", select= T, subset= treatment == "burned")

compare.burned.AIC=AIC(m1.compare.burned.gam, m2.compare.burned.gam, m3.compare.burned.gam)
compare.burned.AIC
summary(m1.compare.burned.gam)
...
compare.burned.mod.plot<-
  plot_smooths(
  model = m1.compare.burned.gam,
  series = plant.specific.mass..g,
  comparison = plant.type
) + 
  geom_point(data=plant.df[(plant.df$treatment=="burned"),], 
...
m1.compare.unburned.gam=gam(perc.loss ~ plant.type + s(plant.specific.mass..g, by=plant.type), data=plant.df, methods= "REML", select= T, subset= treatment == "unburned")

m2.compare.unburned.gam=gam(perc.loss ~ plant.type + s(plant.specific.mass..g), data=plant.df, methods= "REML", select= T, subset= treatment == "unburned")

m3.compare.unburned.gam=gam(perc.loss ~ s(plant.specific.mass..g), data=plant.df, methods= "REML", select= T, subset= treatment == "unburned")

compare.unburned.AIC=AIC(m1.compare.unburned.gam, m2.compare.unburned.gam, m3.compare.unburned.gam)
compare.unburned.AIC
...
compare.unburned.mod.plot<-
  plot_smooths(
  model = m3.compare.unburned.gam,
  series = plant.specific.mass..g
) + 
  geom_point(data=plant.df[(plant.df$treatment=="unburned"),], 
             aes(x=plant.specific.mass..g, y=perc.loss, color=plant.type)) +
   scale_color_manual(values = c("mediumpurple4", "darkgoldenrod4")) +
     scale_fill_manual(values = c("mediumpurple4", "darkgoldenrod4")) +
  ggtitle("Unburned") +
...
rownames(AIC.compare.decomp.mod)<-c(1:6)

write.csv(AIC.compare.decomp.mod, "output/AIC models/AIC.comapre.decomp.csv")

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/decomp.compare.mod.AIC.pdf", width = 5.7, height = 2)       # Export PDF
grid.table(AIC.compare.decomp.mod)
dev.off()

...
index.mod.allsums=rbind(suva.mod.allsums,hix.mod.allsums,sr.mod.allsums,fr.mod.allsums,fl.mod.allsums)

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/index.mod.allsums.pdf", width = 8.6, height = 17)       # Export PDF
grid.table(index.mod.allsums, rows=NULL)
dev.off()

#merge all the dataframes
index.mod.AIC=rbind(AIC.suva.mod,AIC.hix.mod,AIC.sr.mod,AIC.fr.mod,AIC.fl.mod)

#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/index.mod.AIC.pdf", width = 6.5, height = 17)       # Export PDF
grid.table(index.mod.AIC, rows=NULL)
dev.off()

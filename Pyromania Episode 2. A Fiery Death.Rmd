...
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/DOC.mod.AIC.pdf", width = 8.5, height = 3.8)       # Export PDF
...
#convert dataframe into a table for export
pdf("/Users/Cody1/Desktop/GitHub/Pyromania2/output/Codys.tables/sr.mod.AIC.pdf", width = 5.5, height = 3.8)       # Export PDF
...
decomp.combo.mod.plot<-plot_grid(
decomp.mod.plot+ theme(legend.position = "none"),
decomp.compare.mod.plot+ theme(legend.position = "none"),
nrow=2)

decomp.combo.mod.plot

ggsave("figures/decomp.combo.mod.plot.pdf", height=4, width=12)
